...
export enum Routes {
  ...
  // Chili Career marketing pages — docs/design-spec.md §3.2
  Services = '/services',
  ServiceRecruitment = '/services#recruitment',
  ServiceExecutiveSearch = '/services#executive-search',
  ServiceHrConsulting = '/services#hr-consulting',
  Testimonials = '/testimonials',
  Partners = '/partners',
  Events = '/events',
  Contact = '/contact',

  // German statutory pages — both are legally mandatory and must be
  // reachable from the footer of every page.
  // Impressum: § 5 DDG · Datenschutz: DSGVO
  Imprint = '/impressum',
  Privacy = '/datenschutz',
